    ...
    : wxDialog(parent, id, title, pos, size, style), tools(tools), m_selectedCountry(selectedCountry)
{
    ...
    m_toggleButton29 = new wxToggleButton(this, wxID_ANY, _("Heimtrikot"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_toggleButton29->SetValue(true);

    boxSizer23->Add(m_toggleButton29, 0, wxALL, WXC_FROM_DIP(5));

    m_toggleButton31 = new wxToggleButton(this, wxID_ANY, _("Auswärtstrikot"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_toggleButton31->SetValue(false);

    boxSizer23->Add(m_toggleButton31, 0, wxALL, WXC_FROM_DIP(5));

    wxStaticBoxSizer* staticBoxSizer33 = new wxStaticBoxSizer(new wxStaticBox(this, wxID_ANY, _("Trikot Eigenschaften")), wxVERTICAL);
    ...
    m_staticText37 = new wxStaticText(this, wxID_ANY, _("Trikotfarbe 1"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_staticText41 = new wxStaticText(this, wxID_ANY, _("Trikotfarbe 2"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_staticText45 = new wxStaticText(this, wxID_ANY, _("Hosenfarbe"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_staticText49 = new wxStaticText(this, wxID_ANY, _("Stutzenfarbe"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_radioButton57 = new wxRadioButton(this, wxID_ANY, _("neutral"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_radioButton57->SetValue(1);

    flexGridSizer55->Add(m_radioButton57, 0, wxALL, WXC_FROM_DIP(5));

    m_radioButton59 = new wxRadioButton(this, wxID_ANY, _("Brustring"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_radioButton59->SetValue(1);

    flexGridSizer55->Add(m_radioButton59, 0, wxALL, WXC_FROM_DIP(5));

    m_radioButton61 = new wxRadioButton(this, wxID_ANY, _("längs"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_radioButton61->SetValue(1);

    flexGridSizer55->Add(m_radioButton61, 0, wxALL, WXC_FROM_DIP(5));

    m_radioButton63 = new wxRadioButton(this, wxID_ANY, _("Ärmel"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_radioButton63->SetValue(1);

    flexGridSizer55->Add(m_radioButton63, 0, wxALL, WXC_FROM_DIP(5));

    m_radioButton65 = new wxRadioButton(this, wxID_ANY, _("quer"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_radioButton65->SetValue(1);

    flexGridSizer55->Add(m_radioButton65, 0, wxALL, WXC_FROM_DIP(5));

    m_radioButton67 = new wxRadioButton(this, wxID_ANY, _("Mittelstr."), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_radioButton67->SetValue(1);

    flexGridSizer55->Add(m_radioButton67, 0, wxALL, WXC_FROM_DIP(5));

    m_radioButton69 = new wxRadioButton(this, wxID_ANY, _("Halb/Halb"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_radioButton69->SetValue(1);

    flexGridSizer55->Add(m_radioButton69, 0, wxALL, WXC_FROM_DIP(5));

    m_radioButton71 = new wxRadioButton(this, wxID_ANY, _("kariert"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_radioButton71->SetValue(1);

    flexGridSizer55->Add(m_radioButton71, 0, wxALL, WXC_FROM_DIP(5));

    m_radioButton73 = new wxRadioButton(this, wxID_ANY, _("Schulter"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_radioButton73->SetValue(1);

    flexGridSizer55->Add(m_radioButton73, 0, wxALL, WXC_FROM_DIP(5));

    m_radioButton75 = new wxRadioButton(this, wxID_ANY, _("schräg"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_checkBox81 = new wxCheckBox(this, wxID_ANY, _("Ringelsocken"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
