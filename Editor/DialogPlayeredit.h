...
protected:
    ...
    wxCheckBox* m_checkPlusFiringpower;
    wxCheckBox* m_checkMinusFiringpower;
    ...
    wxCheckBox* m_checkPlusGoalinstinct;
    wxCheckBox* m_checkMinusGoalinstinct;
    wxCheckBox* m_checkPlusRunner;
    wxCheckBox* m_checkMinusRunner;
    ...
    wxCheckBox* m_checkPlusQuadchain;
    wxCheckBox* m_checkMinusQuadchain;
    wxCheckBox* m_checkPlusGameoverview;
    wxCheckBox* m_checkMinusGameoverview;
    ...
    wxCheckBox* m_checkPlusComingout;
    wxCheckBox* m_checkMinusComingout;
    ...
    wxCheckBox* m_checkPlusBallcontrol;
    wxCheckBox* m_checkMinusBallcontrol;
    ...
    wxCheckBox* m_checkPlusWidedrops;
    wxCheckBox* m_checkMinusWidedrops;
