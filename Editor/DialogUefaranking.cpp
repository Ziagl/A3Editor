    ...
    : wxDialog(parent, id, title, pos, size, style), tools(tools)
{
    ...
    additional = tools->getAdditional();
...
void DialogUefaranking::initializeCountryList(wxListCtrl* control)
{
    ...
    auto teams = additional->getValue();
