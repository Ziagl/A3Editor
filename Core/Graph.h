...
namespace Core
{
    ...
    public:
        ...
        vertex_t getTeamIdByPlayerId(vertex_t playerId);
        // player
        ...
        // other player
        vertex_t addOtherPlayer(std::shared_ptr<Player> player, vertex_t nationId);
        std::shared_ptr<Player> getOtherPlayerById(vertex_t playerId);
        std::vector<vertex_t> getOtherPlayerIds();
        // nation
        ...
        // other
        vertex_t addAdditional(std::shared_ptr<Additional> uefaranking);
        std::shared_ptr<Additional> getAdditional();
        ...
        vertex_t addPlayerpool(std::shared_ptr<Playerpool> playerpool);
        std::shared_ptr<Playerpool> getPlayerpool();
        vertex_t addCompetition(std::shared_ptr<Competition> competition);
        std::shared_ptr<Competition> getCompetition();
